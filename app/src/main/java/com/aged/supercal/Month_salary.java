...
public class Month_salary extends AppCompatActivity implements View.OnClickListener{
    ...
    private double baseNum_1 ;//社保汇缴基数
    private double baseNum_2 ;//公积金汇缴
    ...
    public void onClick(View v){
        ...
        if(tax_start_point.getText().toString().equals("")){
            ...
            if (taxbefore_point == 0 || taxbefore_point == 0) {
                Toast.makeText(Month_salary.this, "请不要调皮输入0", Toast.LENGTH_SHORT).show();

            }else {

                getCity(strCity);//获取城市
            ...
            } else if (taxbefore_point > baseNum_1) {
                //个人缴纳
            ...
            if (taxbefore_point > taxstart_point) {   //大于起征点
                ...
                if (3000 < tax_person && tax_person <= 12000)
                    result_1 = tax_person * 0.10 - 210;    //3000-12000
                if (12000 < tax_person && tax_person <= 25000)
                    result_1 = tax_person * 0.20 - 1410;   //12000-25000
                if (25000 < tax_person && tax_person <= 35000)
                    result_1 = tax_person * 0.25 - 2660;   //25000-35000
                if (35000 < tax_person && tax_person <= 55000)
                    result_1 = tax_person * 0.30 - 4410;   //35000-55000
                if (55000 < tax_person && tax_person <= 80000)
                    result_1 = tax_person * 0.35 - 7160;   //55000-80000
                if (tax_person > 80000)
                    result_1 = tax_person * 0.45 - 15160;   //大于80000                           tax_person=tax_person*0.45-181920;   //大于9600000
            }
